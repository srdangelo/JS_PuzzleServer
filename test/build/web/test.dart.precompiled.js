...
["test", "test.dart", , X, {
  ...
  initWebSocket: function(retrySeconds) {
    ...
    t2 = W.WebSocket_WebSocket("ws://127.0.0.1:3030/ws", null);
    $.ws = t2;
  ...
  initWebSocket_scheduleReconnect: {
    ...
    call$0: function() {
      ...
      if (!t1.reconnectScheduled_0) {
        ...
        P.Timer_Timer(P.Duration$(0, 0, 0, 1000 * t2, 0, 0), new X.initWebSocket_scheduleReconnect_closure(t2));
      }
      t1.reconnectScheduled_0 = true;
    }
  },
  initWebSocket_scheduleReconnect_closure: {
    "^": "Closure:11;retrySeconds_2",
    call$0: function() {
      return X.initWebSocket(this.retrySeconds_2 * 2);
    }
  },
  ...
  initWebSocket_closure0: {
    "^": "Closure:10;retrySeconds_3,scheduleReconnect_4",
    call$1: function(e) {
  ...
  initWebSocket_closure1: {
    "^": "Closure:10;scheduleReconnect_5",
    call$1: function(e) {
  ...
  Box: {
    ...
    static: {Box$: function(id, x, y, color) {
        var t1 = new X.Box(x, y, color, id, null, W.ImageElement_ImageElement(null, null, null), null, null, null, null, null, null, null, null, null);
  ...
  State: {
    "^": "Object;myBoxes,tlayer,lastLength",
    updateBox$4: function(id, x, y, color) {
      ...
      if (!found) {
        temp = X.Box$(id, x, y, color);
        this.tlayer.touchables.push(temp);
    ...
    findTouchTarget$1: function(tp) {
      ...
      for (t1 = this.layers, i = t1.length - 1; i >= 0; --i) {
        ...
        if (t != null) {
          if (i >= t1.length)
            return H.ioore(t1, i);
          return new X.TouchBinding(t1[i], t);
        }
      }
      return;
    },
  ...
  TouchManager_registerEvents_closure0: {
    ...
    call$1: function(e) {
      ...
      target = t2.$index(0, -1);
      if (target != null)
        target.touchUp$1(X.Contact$fromMouse(e));
  ...
  TouchLayer: {
    ...
    findTouchTarget$1: function(tp) {
      var c, t1, i;
      c = new X.Contact(null, -1, 0, 0, false, false, false, false, false);
      c.Contact$copy$1(tp);
      if (this.enabled)
  ...
  Contact: {
    ...
    static: {Contact$fromMouse: function(mouse) {
        var t1 = new X.Contact(null, -1, 0, 0, false, false, false, false, false);
...
X.TouchLayer.$isObject = true;
X.Touchable.$isObject = true;
X.TouchBinding.$isObject = true;
X.Box.$isObject = true;
...
function dart_precompiled($collectedClasses) {
  ...
  function Box(x, y, color, id, dragged, img, rightBuddy, leftBuddy, upperBuddy, lowerBuddy, leftNeighbor, rightNeighbor, upperNeighbor, lowerNeighbor, dragTimer) {
    this.x = x;
    this.y = y;
    this.color = color;
    this.id = id;
    ...
    this.upperBuddy = upperBuddy;
    this.lowerBuddy = lowerBuddy;
  ...
  Box_closure.builtin$cls = "Box_closure";
  if (!"name" in Box_closure)
    Box_closure.name = "Box_closure";
  $desc = $collectedClasses.Box_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function TouchLayer(touchables, touch_bindings, enabled) {
